...
function main() {
    let x = npp([1,1,5],[1,2,5],[3,1,1]);
    console.log(x.solvedProcessesInfo[0]);
    console.log(x.solvedProcessesInfo[1]);
    console.log(x.solvedProcessesInfo[2]);
    console.log(x.ganttChartInfo[0])
}
